...
/**
 * File: home.php
 * Purpose: Blog posts listing page (when static front page is set)
 * Notes: This template is used for the "Posts page" in Settings > Reading
 *        10 posts per page with thumbnails, pagination
 */
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <h1 class="hrgms-hero-title">
                    <?php
                    // Get the blog page title if set
